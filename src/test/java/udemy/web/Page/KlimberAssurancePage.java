...
public class KlimberAssurancePage extends WebDriverHelper {
  ...
  public void waitForFirstStepElements() {
    ...
    Assert.assertTrue(
        isWebElementDisplayed(SUB_TITLE_LOC), "Sub title element was not visible on page");
    Assert.assertTrue(
        isWebElementDisplayed(FULL_NAME_LOC), "Full name element was not visible on page");
    Assert.assertTrue(
        isWebElementDisplayed(PROVINCE_LOC), "Select Province element was not visible on page");
    Assert.assertTrue(
        isWebElementDisplayed(AREA_CODE_LOC), "Area code element was not visible on page");
    Assert.assertTrue(
        isWebElementDisplayed(PHONE_NUMBER_LOC), "Phone number element was not visible on page");
  }
  ...
  public void waitForSecondStepElements() {
    ...
    Assert.assertTrue(
        isWebElementDisplayed(DIV_ADULTS_QUANTITY),
        "Adults quantity element was not visible on page");
    Assert.assertTrue(
        isWebElementDisplayed(DIV_CHILDREN_QUANTITY),
  ...
  public void waitForLastStepElements() {
    ...
    Assert.assertTrue(
        isWebElementDisplayed(SURNAME_LOC), "Surname element was not visible on page");
    Assert.assertTrue(
        isWebElementDisplayed(BIRTHDAY_LOC), "Birthday element was not visible on page");
    Assert.assertTrue(isWebElementDisplayed(ID_NUMBER_LOC), "DNI element was not visible on page");
    Assert.assertTrue(
        isWebElementDisplayed(BIOLOGIC_GENDER_LOC),
        "Biologic gender element was not visible on page");
    Assert.assertTrue(
        isWebElementDisplayed(SELF_GENDER_LOC), "Gender element was not visible on page");
    Assert.assertTrue(isWebElementDisplayed(EMAIL_LOC), "Email element was not visible on page");
    Assert.assertTrue(
        isWebElementDisplayed(PHONE_CODE_LOC), "Phone code element was not visible on page");
    Assert.assertTrue(
        isWebElementDisplayed(PHONE_NUMBER_LAST_LOC),
    ...
    Assert.assertTrue(
        isWebElementDisplayed(HOUSE_NUMBER_LOC), "House Number element was not visible on page");
    Assert.assertTrue(isWebElementDisplayed(FLOOR_LOC), "Floor element was not visible on page");
    Assert.assertTrue(
        isWebElementDisplayed(APARTMENT_LOC), "Apartment element was not visible on page");
    Assert.assertTrue(
        isWebElementDisplayed(ZIP_CODE_LOC), "Zip code element was not visible on page");
    Assert.assertTrue(isWebElementDisplayed(CITY_LOC), "City element was not visible on page");
    Assert.assertTrue(
        isWebElementDisplayed(REGISTER_BUTTON_LOC),
  ...
  public void setInputValues(By locator, String key, String valueToBeSet) {
    if (isWebElementDisplayed(locator)) {
      WebElement divElements = getElement(locator);
