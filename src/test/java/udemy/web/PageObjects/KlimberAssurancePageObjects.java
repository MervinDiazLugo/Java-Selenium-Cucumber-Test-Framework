...
public class KlimberAssurancePageObjects {
    ...
    public static final By FIRST_STEP_BUTTON_LOC = By.cssSelector("button[id='btnSubmitHealthStep1']");
    ...
    public static final By STEPPER_REMOVE_BUTTON = By.xpath(".//button[contains(@class, 'counter-minus')]");
    public static final By STEPPER_ADD_BUTTON = By.xpath(".//button[contains(@class, 'counter-plus')]");
    ...
    public static final By SECOND_STEP_BUTTON_LOC = By.cssSelector("button[id='btnSubmitHealthStep2']");
