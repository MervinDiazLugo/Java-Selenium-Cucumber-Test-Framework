...
public class AndroidDriverProperties {
    ...
    public String getAppBase() {
        String appProperty = String.format("mobile.driver.%s.android.app.%s", getEnvironment(), getClient());
        appBase = prop.getProperty(appProperty) != null ? prop.getProperty(appProperty) : null;

        if (StringUtils.isEmpty(appBase)) {
          appProperty = String.format("mobile.driver.%s.android.app.%s", getPropertiesEnvironment(), getPropertiesClient());
          appBase = prop.getProperty(appProperty) != null ? prop.getProperty(appProperty) : null;
        }
